		...
		<section class="text-gray-600 body-font relative">
			<div class="container px-5 mx-auto text-center">
				<div class="text-center mb-10">
					<h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Password reset sent</h1>
					<p class="lg:w-2/3 mx-auto leading-relaxed text-base">We've emailed you instructions for setting your password, if an account exists with the email you entered. You should receive them shortly.</p>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-base">If you don't receive an email, please make sure you've entered the address you registered with, and check your spam folder.</p>
                </div>
			</div>
		</section>
	</main>
