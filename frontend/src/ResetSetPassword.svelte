		...
		<section class="text-gray-600 body-font relative">
			<div class="container px-5 mx-auto text-center">
				<div class="text-center mb-10">
					<h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">Enter new password</h1>
					<p class="lg:w-2/3 mx-auto leading-relaxed text-base">Please enter your new password twice so we can verify you typed it in correctly.</p>
					{#if messages}
						<p id="error_messages" class="text-warning text-center leading-relaxed my-5">{@html messages}</p>
					{/if}
			  	</div>
				<form id="reset_password_form" on:submit|preventDefault={changePassword}>
					...
					<div class="lg:w-1/2 md:w-2/3 mx-auto">
						...
						<div class="p-2 w-full">
							<div class="relative">
								<label for="id_new_password2" class="text-center leading-7 text-sm text-gray-600">Confirm password:</label>
